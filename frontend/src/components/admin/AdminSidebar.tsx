  ...
  const menuItems = [
    ...
    // ── Catalog / E-commerce ─────────────────────────────────
    {
      ...
      children: [
        ...
        { name: t("admin.banner", "Banner & installations"), href: "/dashboard/banner", perm: "advertisements.manage" },
    ...
    // ── Order operations ─────────────────────────────────────
    {
      ...
      children: [
        ...
        { name: t("admin.inventoryAlerts"), href: "/dashboard/inventory", perm: "analytics.view" },
        { name: t("admin.stockRequests", "Product requests"), href: "/dashboard/stock-requests", perm: "products.view" },
      ],
    },
