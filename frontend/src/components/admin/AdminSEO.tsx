...
const AdminSEO: React.FC = () => {
  ...
  const ogTitleMultilingual = useMultilingualForm(['ogTitle']);
  const ogDescriptionMultilingual = useMultilingualForm(['ogDescription']);
  ...
  const loadSEOData = async () => {
    try {
      ...
      if (data) {
        ...
        ogTitleMultilingual.initializeFromData(data, ['ogTitle']);
        ogDescriptionMultilingual.initializeFromData(data, ['ogDescription']);
  ...
  const handleSave = async () => {
    try {
      ...
      const updateData = {
        ...
        ogTitle: ogTitleMultilingual.multilingualData.ogTitle,
        ogDescription: ogDescriptionMultilingual.multilingualData.ogDescription,
        ...formData,
      };
  ...
  const handleCancel = () => {
    setEditing(false);
    loadSEOData(); // Reload original data
  };
    ...
    <Box bg="white" borderRadius="2xl" p={8} boxShadow="sm" border="1.5px solid #E9ECEF" maxW="1200px" mx="auto">
      ...
      <Alert status="info" borderRadius="lg" mb={6}>
        ...
        <Box>
          ...
          <Text fontSize="sm">
            ...
            Optimize images with descriptive alt text • Ensure mobile-friendly design
          </Text>
        </Box>
      </Alert>
      ...
      {editing ? (
        <VStack spacing={8} align="stretch">
          ...
          {/* Open Graph Section */}
          <Box>
            <Heading size="md" color="gray.700" mb={4}>Open Graph (Social Media)</Heading>
            <Grid templateColumns={{ base: '1fr', lg: '1fr 1fr' }} gap={6}>
              <MultilingualFieldComponent
                label="OG Title"
                fieldName="ogTitle"
                value={ogTitleMultilingual.multilingualData.ogTitle?.en || ''}
                multilingualData={ogTitleMultilingual.multilingualData.ogTitle || {}}
                onChange={(value) => ogTitleMultilingual.updateEnglishValue('ogTitle', value)}
                onMultilingualChange={(lang, value) => ogTitleMultilingual.updateMultilingualValue('ogTitle', lang, value)}
              ...
              <MultilingualFieldComponent
                ...
                value={ogDescriptionMultilingual.multilingualData.ogDescription?.en || ''}
                multilingualData={ogDescriptionMultilingual.multilingualData.ogDescription || {}}
                onChange={(value) => ogDescriptionMultilingual.updateEnglishValue('ogDescription', value)}
                onMultilingualChange={(lang, value) => ogDescriptionMultilingual.updateMultilingualValue('ogDescription', lang, value)}
                isTextArea={true}
          ...
          <Box>
            <Heading size="md" color="gray.700" mb={4}>Twitter Card</Heading>
          ...
          <Box>
            <Heading size="md" color="gray.700" mb={4}>Advanced SEO</Heading>
            <Grid templateColumns={{ base: '1fr', md: '1fr 1fr' }} gap={6}>
              ...
              <FormControl>
                ...
                <Select value={formData.ogLocale} onChange={(e) => handleInputChange('ogLocale', e.target.value)}>
        ...
        <VStack spacing={6} align="stretch">
          ...
          <Text fontSize="lg" fontWeight="bold" mb={2}>Open Graph Settings</Text>
          <Grid templateColumns={{ base: '1fr', md: '1fr 1fr' }} gap={4}>
            <Box>
              <Text fontWeight="medium">OG Title:</Text>
              <Text color="gray.600">{seoData?.ogTitle?.en || seoData?.title?.en || 'Not set'}</Text>
            </Box>
            <Box>
