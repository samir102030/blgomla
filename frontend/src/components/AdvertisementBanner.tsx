        ...
        >
          ...
          <div className="flex flex-col p-6 md:p-8 gap-3 overflow-y-auto">
            ...
            <div className="mt-auto pt-4 flex flex-col gap-2">
              <button
                onClick={handleCta}
                className="w-full inline-flex items-center justify-center gap-2 font-semibold rounded-xl bg-gradient-to-r from-[#00A8E8] to-[#0077B6] text-white shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all px-6 py-3 text-sm md:text-base"
              >
                {ctaLabel}
                {currentAd.link && (
                  <svg
