...
const statusConfig: Record<string, { icon: string; color: string; bgColor: string }> = {
  pending: { icon: "⏳", color: "text-amber-600", bgColor: "bg-amber-100 dark:bg-amber-900/30" },
  paid: { icon: "💳", color: "text-blue-600", bgColor: "bg-blue-100 dark:bg-blue-900/30" },
  confirmed: { icon: "✅", color: "text-emerald-600", bgColor: "bg-emerald-100 dark:bg-emerald-900/30" },
  processing: { icon: "⚙️", color: "text-indigo-600", bgColor: "bg-indigo-100 dark:bg-indigo-900/30" },
  shipped: { icon: "🚚", color: "text-purple-600", bgColor: "bg-purple-100 dark:bg-purple-900/30" },
  out_for_delivery: { icon: "📦", color: "text-orange-600", bgColor: "bg-orange-100 dark:bg-orange-900/30" },
  delivered: { icon: "🎉", color: "text-emerald-600", bgColor: "bg-emerald-100 dark:bg-emerald-900/30" },
  cancelled: { icon: "❌", color: "text-red-600", bgColor: "bg-red-100 dark:bg-red-900/30" },
  refunded: { icon: "💸", color: "text-gray-600", bgColor: "bg-gray-100 dark:bg-gray-900/30" },
};
