...
import { BuildingStorefrontIcon, ClockIcon, XMarkIcon } from "@heroicons/react/24/outline";
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border">
                  <div className="flex items-center">
                    <div className="p-2 bg-[var(--brand-primary)]/10 rounded-lg">
                      <span className="text-2xl"><BuildingStorefrontIcon className="w-6 h-6" aria-hidden="true" /></span>
                    </div>
                    <div className="ml-4">
