  ...
  const values = [
    {
      icon: '🎯',
      title: 'Quality First',
      description: 'We only stock cameras and equipment from trusted brands known for their reliability and performance.'
    },
    {
      icon: '💡',
      title: 'Expert Guidance',
      description: 'Our team of photography experts is here to help you find the perfect camera for your needs.'
    },
    {
      icon: '🚚',
      title: 'Fast Delivery',
      description: 'Quick and secure shipping to get your new camera equipment to you as soon as possible.'
    },
    {
      icon: '🛡️',
      title: 'Warranty Protection',
      description: 'All our products come with comprehensive warranty coverage for your peace of mind.'
    }
  ];
...
Whether you're an IT professional, a growing business, or a home user looking to upgrade your setup, we offer the right networking equipment and solutions to keep you connected and in control.
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">What drives us to serve you better every day</p>
            </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">The passionate people behind Belgomla</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Choose Belgomla?</h2>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <ul className="space-y-6">
                  <li className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h3 className="text-lg font-semibold text-gray-900">Authentic Products Only</h3>
                      <p className="text-gray-600">All our cameras and accessories are 100% genuine and come with official warranties.</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <div className="flex-shrink-0 w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center mt-1">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-600">Our knowledgeable team provides personalized recommendations and technical support.</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <div className="flex-shrink-0 w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center mt-1">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-600">We offer the best prices in the market without compromising on quality or service.</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <div className="flex-shrink-0 w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center mt-1">
                    ...
                    <div className="ml-4">
                      <h3 className="text-lg font-semibold text-gray-900">Hassle-Free Returns</h3>
                      <p className="text-gray-600">30-day return policy with no questions asked if you're not completely satisfied.</p>
                    </div>
                  </li>
                </ul>
              </div>
